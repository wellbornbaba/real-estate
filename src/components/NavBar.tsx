...
export default function NavBar() {
  ...
  const { searchQuery, setSearchQuery } = searchContent;
  // Local state for managing input (optional if you want it to be debounced)
  ...
  const handleSearch = () => {
    ...
    setSearchQuery(localQuery); // Update the global search state
    console.log("Search triggered for:", localQuery); // Replace with your search logic
  };
              ...
              <li>
                ...
                <li>
                  <input
                    ...
                    className="border p-2 text-gray-700 rounded-full border-teal-600 px-3 text-lg"
